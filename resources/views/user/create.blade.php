          ...
          <form action="{{ route('user.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <label for="photo" class="col-sm-3 control-label">@lang('web.user.photo')</label>

                <div class="col-sm-8">
                  <input type="file" name="photo" id="user-photo" class="form-control" value="{{ old('photo') }}">
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-6">
                <button type="submit" class="btn btn-default">
                  <i class="fa fa-plus"></i> @lang('web.btn.add-user')
                </button>
              </div>
            </div>
          </form>
